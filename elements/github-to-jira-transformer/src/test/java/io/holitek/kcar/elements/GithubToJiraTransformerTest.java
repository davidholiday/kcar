 ...
 *
 */
public class GithubToJiraTransformerTest extends CamelTestSupport {

    private static final Logger LOG = LoggerFactory.getLogger(GithubToJiraTransformerTest.class);
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:start")
                        .process(new GithubToJiraTransformer())
                        .to("mock:result");
            }
        };
    }
