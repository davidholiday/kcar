 ...
 */
public class EmptyRoute extends RouteBuilder {

    private static final Logger LOG = LoggerFactory.getLogger(EmptyRoute.class);

    // anything to do with this route - from properties to identification - will use this top level key
    public static final String NAMESPACE_KEY = Introspector.decapitalize(EmptyRoute.class.getSimpleName());
