 ...
 */
public class GithubToJiraService implements ServletContextListener {

    private static final Logger LOG = LoggerFactory.getLogger(GithubToJiraService.class);
    ...
    public static final String NAMESPACE_KEY =
        Introspector.decapitalize(GithubToJiraService.class.getSimpleName());
